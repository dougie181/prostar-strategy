...
Our organisation provides aluminium and cabinet-related products to Bunnings, with 80% of products manufactured and sourced from China, shipped via 3PLs, and delivered to Bunnings stores across Australia and New Zealand. We also manufacture custom aluminium and cabinetry for bespoke customer requirements. Our core business challenges are optimising systems to ensure on-time delivery of quality products while scaling to meet customer demands and growth.
...
**Integration:**
- The Order Exchange (TOE) EDI for Bunnings orders, 3PL shipments, and invoicing

**Additional Systems:**
- Netstock (purchasing - finished products only)
- Excel spreadsheets (purchasing)
- Velixo (data extraction)
- ELMO (HR/payroll)
- HUMAND (workplace communication)
- Telstra Calling for Office (telephony)
- DocuSign
...
- Projects Overview
- Acumatica Problems Documentation

### Appendix B: Glossary of Terms

- **BA/PM:** Business Analysis and Project Management
